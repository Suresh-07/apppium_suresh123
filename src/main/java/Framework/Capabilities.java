...
//	{
//		Thread.sleep(50000);
////		Runtime.getRuntime().exec(System.getProperty("user.dir")+"//12.bat");
////		Thread.sleep(10000);
//	}
	public static AndroidDriver<AndroidElement> hybrid_capabilities(String appactivity, String apppackage, String deviceName, String chromeexcutable) throws IOException{
		...
		FileReader gp = new FileReader(System.getProperty("user.dir")+"//src//main//java//Framework//Global.properties");
